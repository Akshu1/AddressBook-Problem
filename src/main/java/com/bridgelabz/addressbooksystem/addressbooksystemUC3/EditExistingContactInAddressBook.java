package com.bridgelabz.addressbooksystem.addressbooksystemUC3;
...
class AddressBook {
	...
	void editContactInfo() throws Exception {
		...
		readFile(contactName);
		System.out.println("Enter the 8 lines of  new content to write:");
		String newContent = "";
		for (int i = 1; i <= 8; i++) {
...
public class EditExistingContactInAddressBook {
	// class variable
	static final Scanner scanner = new Scanner(System.in);
